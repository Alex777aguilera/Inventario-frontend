  ...
  const reloadr = (event) =>{
   ...
   const reloadv = (event) =>{
    ...
    const Report_Stock = ()=>{
      ...
      window.open(`http://atenea/ReportServer/Pages/ReportViewer.aspx?%2fAPCLIN_REPORT%2fReportestock&rs:Command=Render&rs:embed=true&rc:Parameters=false&id_enterprise=${cookies.get('enterprise')}`,'_blank');
