...
export default function Kardex(props) {
    ...
    const Report_Entradas=()=>{
      ...
      if(data.f_i.value === '' || data.f_s.value === ''){
        ...
        window.open(`http://atenea/ReportServer/Pages/ReportViewer.aspx?%2fAPCLIN_REPORT%2fReporteTrazabalidadEntradas&rs:Command=Render&rs:embed=true&rc:Parameters=false&fechae=${data.f_i.value}&fechas=${data.f_s.value}&id_enterprise=${cookies.get('enterprise')}`,'_blank');
        data.f_i.value = ''
        data.f_s.value = ''
      }
    }
    ...
    const Report_Salidas=()=>{
      ...
      if(data2.f_i2.value === '' || data2.f_s2.value === ''){
        ...
        console.log('Salidas')
        window.open(`http://atenea/ReportServer/Pages/ReportViewer.aspx?%2fAPCLIN_REPORT%2fReporteTrazabalidadSalida&rs:Command=Render&rs:embed=true&rc:Parameters=false&fechae=${data2.f_i2.value}&fechas=${data2.f_s2.value}&id_enterprise=${cookies.get('enterprise')}`,'_blank');
        data2.f_i2.value = ''
        data2.f_s2.value = ''
      }
    }
