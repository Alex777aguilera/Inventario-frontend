...
$(document).ready(function () {
  ...
  if(window.location.href === `${cookies.get('local')}Semaforizacion/Rojo`){
    $.ajax({
      type: "DELETE",
...
export default function Semaforizacion_Rojo(props) {
    ...
    // 
   const Report_SRojo=()=>{
      window.open(`http://atenea/ReportServer/Pages/ReportViewer.aspx?%2fAPCLIN_REPORT%2fReporteSemaforizaciónRojo&rs:Command=Render&rs:embed=true&rc:Parameters=false&id_enterprise=${cookies.get('enterprise')}`,'_blank');
    }
